...
//comment routes
Route::get('/newblog/addcomment/{id}','CommentController@create')->name('add.comment');
Route::post('/newblog/comment/store','CommentController@store')->name('store.comment');
Route::get('/newblog/comment/cancel/{blogid}','CommentController@cancel');
Route::get('/newblog/comment/edit/{cmnt}','CommentController@edit');
Route::put('/newblog/comment/update/{cmnt}','CommentController@update')->name('update.comment');
Route::get('/newblog/comment/delete/{cmnt}','CommentController@destroy');
